...
const POSTS = [
  ...
  body: `
    ...
    <!-- IMAGENS -->
    <div class="media-block"><span class="media-icon">🖼️</span><div><div class="media-label">Imagem</div><div class="media-title">Exemplo de integração multimídia</div><div class="media-src">https://upload.wikimedia.org/wikipedia/commons/3/3f/Multimedia.svg</div></div></div>
    <div class="media-block"><span class="media-icon">🖼️</span><div><div class="media-label">Imagem</div><div class="media-title">Componentes da multimídia</div><div class="media-src">https://upload.wikimedia.org/wikipedia/commons/6/6e/Multimedia_Elements.png</div></div></div>

    <ul>
      <li><strong>Texto:</strong> O texto é a espinha dorsal de qualquer conteúdo digital...</li>
      <li><strong>Imagem:</strong> A imagem comunica de forma instantânea...</li>
      <li><strong>Áudio:</strong> O áudio é a linguagem multimídia mais subestimada...</li>
      <li><strong>Vídeo:</strong> O vídeo é o formato de maior engajamento...</li>
      <li><strong>Interatividade:</strong> A interatividade transforma o usuário em participante...</li>
    </ul>

    <!-- VÍDEOS EXISTENTES -->
    <div class="media-block"><span class="media-icon">🎬</span><div>
      <div class="media-label">Vídeo Externo 1</div>
      <div class="media-title">What is Multimedia?</div>
      <div class="media-src">https://www.youtube.com/watch?v=7s0p9c4k4mM</div>
    </div></div>

    <div class="media-block"><span class="media-icon">🎬</span><div>
      <div class="media-label">Vídeo Externo 2</div>
      <div class="media-title">Introduction to Multimedia</div>
      <div class="media-src">https://www.youtube.com/watch?v=0YFrGy_mzjY</div>
    </div></div>

    <!-- VÍDEO CRIADO -->
    <div class="media-block"><span class="media-icon">🎥</span><div>
      <div class="media-label">Vídeo Criado</div>
      <div class="media-title">Resumo Animado sobre Multimídia</div>
      <div class="media-src">https://example.com/videos/multimidia-resumo.mp4</div>
    </div></div>

    <!-- ÁUDIOS EXISTENTES -->
    <div class="media-block"><span class="media-icon">🔊</span><div>
      <div class="media-label">Áudio Externo 1</div>
      <div class="media-title">Podcast sobre Mídia Digital</div>
      <div class="media-src">https://open.spotify.com/episode/4uLU6hMCjMI75M1A2tKUQC</div>
    </div></div>

    <div class="media-block"><span class="media-icon">🔊</span><div>
      <div class="media-label">Áudio Externo 2</div>
      <div class="media-title">Evolução da Comunicação Digital</div>
      <div class="media-src">https://anchor.fm/tech-insights/episodes/digital-media</div>
    </div></div>

    <!-- ÁUDIO CRIADO -->
    <div class="media-block"><span class="media-icon">🎧</span><div>
      <div class="media-label">Áudio Criado</div>
      <div class="media-title">Explicação Narrada sobre Multimídia</div>
      <div class="media-src">https://example.com/audios/multimidia-explicacao.mp3</div>
    </div></div>

    <h3>Multimídia Linear vs. Não-linear</h3>
    <p>Se você cria conteúdo para a internet...</p>

    <!-- LINKS EXTERNOS -->
    <div class="media-block"><span class="media-icon">🌐</span><div>
      <div class="media-label">Link Externo 1</div>
      <div class="media-title">Relatório Horizon</div>
      <div class="media-src">https://www.nmc.org/horizon-report</div>
    </div></div>

    <div class="media-block"><span class="media-icon">🌐</span><div>
      <div class="media-label">Link Externo 2</div>
      <div class="media-title">Artigo sobre Multimídia</div>
      <div class="media-src">https://www.interaction-design.org/literature/topics/multimedia</div>
    </div></div>
